...
class TestFreeTier:
    ...
    def test_second_site_402(self, user_a):
        ...
        assert "1 site" in detail.lower() or "limite" in detail.lower(), detail
...
# ----- Note: Free-tier bypass via DB pro_until is no longer possible -----
# All users are limited to 1 site max, regardless of plan.
# is_pro() still applies to custom domain and shop creation features only.
