        ...
        <div className="mt-8 flex flex-col md:flex-row gap-4 max-w-2xl mx-auto">
          ...
          >
            <div className="flex-1 min-w-0">
              <div className="font-display font-bold text-lg mb-1.5">Je suis un professionnel</div>
          ...
          >
            <div className="flex-1 min-w-0">
              <div className="font-display font-bold text-lg mb-1.5">Je cherche un professionnel</div>
